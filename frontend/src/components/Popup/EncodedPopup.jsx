        ...
        <div className={classes.modal}>
          <div className={classes.modalContent}>
            ...
            <div className={classes.dataContainer}>
              ...
              <h3>Input Data</h3>
                {type === 'image' && <img src={dataInput.base64encode} alt="Input" className={classes.modalImage} />}
              ...
              <div className={classes.dataBlock}>
                ...
                <a href={dataEncoded} download={`encoded_` + type +  `.${dataInput.format}`.toLowerCase()} className={classes.downloadButton}>Download Encoded {type}</a>
              </div>
            </div>
          </div>
        </div>            
